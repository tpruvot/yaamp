...
void argon2d_zmy_call(const void *input, void *output)
{
...
void argon2d_zmy_hash(const unsigned char* input, unsigned char* output, unsigned int len)
{
	argon2d_zmy_call(input, output);
}
