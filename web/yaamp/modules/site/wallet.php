...
foreach ($recents as $addr) {
    ...
    echo '</td><td><a class="address" href="/?address=' . $addr . '" style="font-family: monospace; font-size: 1.1em;">' . $addr . '</a></td>';
...
echo graph_earnings_refresh()
{
    var url = "/site/graph_earnings_results?address=$username";
    $.get(url, '', graph_earning3f &nbsp;</font>'}
            }
        },
