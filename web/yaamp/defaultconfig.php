...
if (!defined('YAAMP_FEES_MINING_RANDOM')) define('YAAMP_FEES_MINING_RANDOM', false);
if (YAAMP_FEES_MINING_RANDOM == true) define('YAAMP_FEES_MINING', YAAMP_FEES_MINING + (YAAMP_FEES_MINING /10) * mt_rand() / mt_getrandmax());
